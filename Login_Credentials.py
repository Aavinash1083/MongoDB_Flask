...
#mongo = PyMongo(app)
cluster = MongoClient("mongodb+srv://aavinash1083:9090909090@cluster0.zkfyq.mongodb.net/aavinash1083?retryWrites=true&w=majority")
db = cluster.aavinash1083
collections = db.LoginCredentials
@app.route('/')
def index():
